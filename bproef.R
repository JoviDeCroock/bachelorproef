...
barplot(renderTimeList, col=colors()[c(23,89,12)] , border="white", font.axis=2, beside=T, legend=rownames(renderTimeList), xlab="Criterion", ylab="time in s", font.lab=2)
